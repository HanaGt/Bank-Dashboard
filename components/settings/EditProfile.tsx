...
const EditProfile: React.FC<EditProfileProps> = ({ isActive }) => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen">
      ...
      >
        <div className="relative w-24 h-24 lg:w-32 lg:h-32 rounded-full bg-slate-500 lg:mt-10 mb-8 lg:mb-0">
          <Image
            src={livia}
            alt="Profile Picture"
            layout="fill"
        ...
        <div className="flex flex-col items-start lg:w-1/3 h-auto lg:h-auto">
          ...
          <input
            ...
            className="w-full p-3 mt-3 border mb-5 rounded-md"
          />
        ...
        <div className="flex flex-col items-start lg:w-1/3 h-auto lg:h-auto">
          ...
          <button
            type="submit"
            className="w-full lg:w-52 h-14 rounded-lg bg-[#1814f3] lg:ml-auto mt-12 text-white"
          >
            Save
          </button>
        </div>
